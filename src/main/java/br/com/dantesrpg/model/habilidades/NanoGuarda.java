...
public class NanoGuarda extends Habilidade {
	public NanoGuarda() {
		super("Nano-Guarda", "Redireciona golpes leves de aliados próximos para si.", TipoHabilidade.ATIVA, -3, // Custo
																												// de
																												// Mana
																												// (Exemplo)
				45, // Custo de TU (Exemplo)
				1, // Nível 3
