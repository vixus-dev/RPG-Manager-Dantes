...
public class InvocarTentaculo extends Habilidade {

	public InvocarTentaculo() {
		super("Invocar Tentáculo", "Invoca um tentáculo de tinta estacionário.", TipoHabilidade.ATIVA, 1, 120, 1,
	...
	public void executar(Personagem conjurador, int alvoX, int alvoY, List<Personagem> alvos, EstadoCombate estado,
		...
		System.out.println(">>> Tinta se acumula no chão...");
		...
		Personagem tentaculo = new Personagem("Tentáculo de Tinta", new br.com.dantesrpg.model.racas.RaçaPlaceholder(),
		...
		br.com.dantesrpg.model.ArmaMelee chicote = new br.com.dantesrpg.model.ArmaMelee("Chicote de Tinta", "Natural",
				"Tentaculo delicioso", Raridade.COMUM, 0, 6, 1, Atributo.FORCA, 100, 2);
		chicote.setTipoAlvo(TipoAlvo.CONE);
		chicote.setTamanhoArea(45); // Cone estreito
